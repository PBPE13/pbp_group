...
urlpatterns = [
    ...
    path('review/<int:book_id>/edit_review/<int:review_id>/', edit_review, name='edit_review'),
    path('review/<int:book_id>/delete_review/<int:review_id>/', delete_review, name='delete_review'),
]
